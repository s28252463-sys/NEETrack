# NEETrack Application Source Code

This file contains the complete source code for the NEETrack application. You can use this for educational purposes to understand how the application is built.
...
## `src/ai/flows/suggest-study-goals.ts`
...
@layer base {
  :root {
    ...
    --secondary: 215 27.9% 95.5%;
    --secondary-foreground: 225.9 9.3% 34.5%;
    --muted: 215 27.9% 95.5%;
...
## `src/components/SyllabusTracker.tsx`
