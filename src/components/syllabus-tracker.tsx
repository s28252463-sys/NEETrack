...
const initialSyllabus = [
  ...
  },
  {
    ...
    chapters: [
        ...
        { id: 'b4-1', name: 'Transport in Plants', completed: false },
        { id: 'b4-2', name: 'Mineral Nutrition', completed: false },
        ...
        { id: 'b5-1', name: 'Digestion and Absorption', completed: false },
        ...
        { id: 'b6-1', name: 'Reproduction in Organisms', completed: false },
